...
public class Server extends Thread {
    ...
    public boolean processTransactions(Transactions trans) {
        ...
        while ((!objNetwork.getClientConnectionStatus().equals("disconnected"))) //&
        {
            ...
            //    e.printStackTrace();
            //}
            //System.out.println("Inside Server - client connection status : "+objNetwork.getClientConnectionStatus());
            //System.out.print("");
            /*try {
                Thread.sleep(1);
            } catch (InterruptedException e) {
        ...
        //System.out.println("Inside Server out of while loop - client connection status : "+objNetwork.getClientConnectionStatus());
